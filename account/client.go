...
func (c *Client) Info() (AccountInfo, error) {
	out := AccountInfo{}
	err := c.API.SignedRequest("GET", "/v3/account", nil, &out)
	return out, err
}
...
func (c *Client) AllOrders(params AllOrdersParams) (AllOrders, error) {
	out := AllOrders{}
	err := c.API.SignedRequest("GET", "/v3/allOrders", params, &out)
	return out, err
}
...
func (c *Client) OpenOrders(params Params) (OpenOrders, error) {
	out := OpenOrders{}
	err := c.API.SignedRequest("GET", "/v3/openOrders", params, &out)
	return out, err
}
...
func (c *Client) OrderStatus(params OrderStatusParams) (OrderStatus, error) {
	out := OrderStatus{}
	err := c.API.SignedRequest("GET", "/v3/order", params, &out)
	return out, err
}
...
func (c *Client) CancelOrder(params CancelOrderParams) (CancelOrder, error) {
	out := CancelOrder{}
	err := c.API.SignedRequest("DELETE", "/v3/order", params, &out)
	return out, err
}
...
func (c *Client) MarketBuy(params MarketBuyParams) (OrderResponse, error) {
	...
	err := c.API.SignedRequest("POST", "/v3/order", orderParams, &out)
	return out, err
}
...
func (c *Client) TradeList(params Params) (TradeList, error) {
	out := TradeList{}
	err := c.API.SignedRequest("GET", "/v3/myTrades", params, &out)
	return out, err
}
